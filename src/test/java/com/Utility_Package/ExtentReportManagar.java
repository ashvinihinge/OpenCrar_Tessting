...
import com.TestCase.Base_Test_Cases_Class;
...
public class ExtentReportManagar implements ITestListener {
	...
	public void onStart(ITestContext testcontext) {
		...
		htmlReporter.config().setDocumentTitle("Open Cart Automation Reports : ");
		htmlReporter.config().setReportName("Open Cart Functional Testing Reports");
		...
		reports.setSystemInfo("Application", "Open_Cart");
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String imgpath = new Base_Test_Cases_Class().captureScreenShot(result.getName());
